...
def add_item(g):
    ...
    if new_item in g:
        ...
        print(my_func.blue(f"{new_item} is added to the groceries!"))
...
while True:
    ...
    try:
        menu_choice = int(input("1. Add Item - 2. Remove Item - 3. View List - 4. Check/Uncheck Item - 5. Clear List - 6. Exit: "))
    except ValueError:
